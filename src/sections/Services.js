...
export default function Services() {
  return (
    <Section className="services" id="services">
      ...
      <Steps>
        <Step>
          <Calendar className="icon" size={72} />
          <div>
        ...
        <Step>
          <Codesandbox className="icon" size={72} />
          <div>
        ...
        <Step>
          <UploadCloud className="icon" size={72} />
          <div>
